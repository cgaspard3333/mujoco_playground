...
# ==============================================================================
"""Base classes for Sigmaban Humanoid."""
...
from mujoco_playground._src.locomotion.sigmaban import sigmaban_constants as consts
...
def get_assets() -> Dict[str, bytes]:
  ...
  path = mjx_env.MENAGERIE_PATH / "sigmaban"
...
class SigmabanEnv(mjx_env.MjxEnv):
  """Base class for Sigmaban Humanoid environments."""
